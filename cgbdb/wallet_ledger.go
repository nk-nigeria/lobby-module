...
func ListWalletLedger(ctx context.Context, logger runtime.Logger, db *sql.DB, userID uuid.UUID, limit *int, cursor string) ([]runtime.WalletLedgerItem, string, string, error) {
